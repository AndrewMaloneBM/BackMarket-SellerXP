          ...
          <div class="border-t border-bm-border p-4 flex-shrink-0">
            <form @submit.prevent="sendMessage" class="flex gap-2">
              <input
                ...
                class="flex-1 text-sm px-4 py-2.5 border border-bm-border rounded-bm focus:outline-none focus:border-bm-text-hi bg-white text-bm-text-hi placeholder-bm-text-muted"
              />
              <button
                type="submit"
