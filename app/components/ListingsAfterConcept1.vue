      ...
      <form class="md:flex md:items-start">
        <div class="grow">
          <div class="mb-4 grid grid-cols-2 gap-4 lg:grid-cols-5">
            <div class="relative">
              <input id="f-title-c1" type="text" placeholder=" " class="peer h-12 w-full px-3 pt-1 rounded-bm-sm border border-bm-border-action bg-white text-base text-bm-text-hi placeholder:text-transparent focus:outline-none focus:border-bm-text-hi" />
              <label for="f-title-c1" class="pointer-events-none absolute left-3 top-1/2 -translate-y-1/2 truncate text-base text-bm-text-hi transition-all
            ...
            <div class="relative">
              <input id="f-sku-c1" type="text" placeholder=" " class="peer h-12 w-full px-3 pt-1 rounded-bm-sm border border-bm-border-action bg-white text-base text-bm-text-hi placeholder:text-transparent focus:outline-none focus:border-bm-text-hi" />
              <label for="f-sku-c1" class="pointer-events-none absolute left-3 top-1/2 -translate-y-1/2 truncate text-base text-bm-text-hi transition-all
                                        peer-focus:top-2 peer-focus:translate-y-0 peer-focus:text-xs peer-focus:text-bm-text-low
                                        peer-[:not(:placeholder-shown)]:top-2 peer-[:not(:placeholder-shown)]:translate-y-0
