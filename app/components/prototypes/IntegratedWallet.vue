...
<template>
  <div id="concept-5-wallet" class="max-w-6xl">
    ...
    <div class="bg-white rounded-bm border border-bm-border shadow-sm p-6 mb-4">
    ...
    <div class="grid grid-cols-2 gap-4">
      <div class="bg-white rounded-bm border border-bm-border p-5">
        <div class="flex items-center justify-between gap-3"><p class="text-xs text-bm-text-mid">Next payout</p><span class="text-[11px] font-semibold rounded-full bg-green-50 text-green-700 px-2 py-1">BackFunds enabled</span></div>
      ...
      <div id="concept-5-deferred-payout" class="bg-white rounded-bm border border-bm-border p-5 scroll-mt-6">
