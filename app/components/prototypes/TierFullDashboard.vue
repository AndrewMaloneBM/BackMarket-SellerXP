...
<template>
  <div class="max-w-6xl">
    ...
    <div class="grid grid-cols-3 gap-6 mb-6">
      <div class="col-span-2 bg-white rounded-bm border border-bm-border p-6">
      ...
      <div class="bg-[#F1F2F6] rounded-bm p-6">
    ...
    <div class="grid grid-cols-3 gap-6 mb-6">
      <div class="bg-white rounded-bm border border-bm-border p-6"><p class="text-xs text-bm-text-mid mb-2">Future Refunds amount</p><p class="text-2xl font-bold text-bm-text-hi">{{ formatEur(seller.futureRefundsEur) }}</p><p class="text-xs text-bm-text-low mt-1">Predicted refund exposure on orders under warranty</p></div>
      <div class="bg-white rounded-bm border border-bm-border p-6"><p class="text-xs text-bm-text-mid mb-2">Target deferred payout amount</p><p class="text-2xl font-bold text-bm-text-hi">{{ formatEur(seller.targetDpEur) }}</p><p class="text-xs text-bm-text-low mt-1">{{ seller.depositPolicyPct }}% of Future Refunds</p></div>
      <div class="bg-white rounded-bm border border-bm-border p-6"><p class="text-xs text-bm-text-mid mb-2">Current deferred payout amount</p><p class="text-2xl font-bold text-bm-text-hi">{{ formatEur(seller.currentDpEur) }}</p><p class="text-xs text-bm-text-low mt-1">Current amount held as deposit</p></div>
    </div>

    <div class="bg-white rounded-bm border border-bm-border p-6 mb-6">
    ...
    <div class="bg-white rounded-bm border border-bm-border p-6">
